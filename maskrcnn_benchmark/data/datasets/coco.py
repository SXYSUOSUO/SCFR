...
class COCODataset(torchvision.datasets.coco.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        if anno and "day" in anno[0]:
            day = [obj["day"] for obj in anno]
            day = torch.tensor(day)
            target.add_field("day", day)

        if anno and "segementation" in anno[0]:
    ...
    def print(self):
        for i in range(0,4325):
            if len(self.__getitem__(i)[1])==0:
                print (self.__getitem__(i)[2])
    '''