...
_C.MODEL.CLS_WEIGHT = [1.0]
_C.MODEL.NUM_MFPT = 1

_C.MODEL.ONESTAGE = True

_C.MODEL.SHARE_FPT = True
...
_C.MODEL.WINDON_SIZE = 5

_C.MODEL.SAVE_FEATURE = False

_C.MODEL.USE_FPT = True

_C.MODEL.USE_CFPT = True

_C.MODEL.POSITION_EMD = False

_C.MODEL.SAVE_DEBUG_IMAGE = False

_C.MODEL.USE_PREFEATURE = True
# -----------------------------------------------------------------------------
# INPUT
# -----------------------------------------------------------------------------
_C.INPUT = CN()
...
_C.MODEL.BACKBONE.LASTLEVEL = True
...
_C.OUTPUT_DIR = "."
_C.RESULT_DIR = "."
# Result dir only use for cross evaluation
